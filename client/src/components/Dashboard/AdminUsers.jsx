                ...
                ? users.map((el) => {
                  ...
                  if(el.status !== "admin"){
                    ...
                    <>
                      ...
                      <strong className="block">{el.name}</strong>
                      <button className="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 mt-2 mb-3" onClick={() => {dispatch(baned({ baned: false }, el.id))}}>Desbanear</button>
                    </>
                    }
                    </>      
