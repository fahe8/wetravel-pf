                  ...
                  if(el.status !== "admin"){
                    ...
                    (   
                      <>  
                        ...
                        <p>{el.name}</p>
                        <button className="box-decoration-clone bg-gradient-to-r from-indigo-600 to-pink-500 text-white px-2 mt-2" onClick={() => {dispatch(baned({ baned:true }, el.id))}}>Banear usuario</button>
                      </>
                    ) :
                    <>
