    ...
    <div className=''>
        ...
        <div className='bg-[color:var(--about-color)] flex flex-row rounded-lg relative mt-5 mx-5' >
            ...
            <div className='block'>
              ...
              <p className='text-xl text-left ml-5 mr-2'>WeTravel es una plataforma donde podes conseguir hospedaje y tambien ser hospedador, facilicitamos todo el entorno de busqueda ya que podes usar multiples filtros para conseguir un lugar a tu medida.</p>
              <br></br>
